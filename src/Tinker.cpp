...
const PinMapping g_pinmap[] = {
    // Gen 2
#if defined(PLATFORM_ELECTRON_PRODUCTION) && (PLATFORM_ID > PLATFORM_GCC && PLATFORM_ID <= PLATFORM_ELECTRON_PRODUCTION)
...
# if defined(PLATFORM_ELECTRON_PRODUCTION) && PLATFORM_ID == PLATFORM_ELECTRON_PRODUCTION
    ,
